...
namespace App
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //{
            //    //Configuring Min Age authorization
            //    options.AddPolicy("Over15Only", policy =>
            //    policy.Requirements.Add(new MinimumAgeRequirement(15)));

            //    options.AddPolicy("TrustedUser", policy => policy.RequireAssertion(context =>
            //    context.User.HasClaim(c => c.Issuer == "https://my.trustedissuer.com/")));

            //    //Configuring Claims Checks
            ...
            //Claim : An assertion of the truth of something eg. Age, Role with in a company, address
